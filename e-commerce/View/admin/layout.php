        ...
        <table width="100%">
            <tbody>
                ...
                <tr class="align-top" height="615px">
                    <td class="p-3"><span> <?php echo $this->getchild('message')->toHtml(); ?> </span><?php echo $this->getChild('content')->toHtml(); ?></td>
                </tr>

                <tr>
                    <td class="p-0"><?php echo $this->getChild('footer')->toHtml(); ?></td>
                </tr>
            </tbody>
        </table>
    </body>
